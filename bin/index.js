...
const archiver = require('archiver'); // Include archiver
...
// const localFolderPath = path.join(currentPath, 'bin', 'Edge_App_Source_Code/Object_Detection-sample'); // Path to your local folder
const zipFilePath = path.join(currentPath, 'output', `${projectName}.zip`);
